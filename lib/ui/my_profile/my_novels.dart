...
class MyNovels extends StatefulWidget {
  const MyNovels({super.key});

  @override
  State<MyNovels> createState() => _MyNovelsState();
}
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          child: const Text(
                            "Новеллалар",
                            style: TextStyle(
                              color: Color.fromRGBO(195, 200, 140, 1),
                            ),
                          ),
                        ),
                        const SizedBox(width: 20),
